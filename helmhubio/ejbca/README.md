...
It also packages [HelmHubIO MariaDB](https://github.com/helmhub-io/charts/tree/main/helmhubio/mariadb) as the required databases for the EJBCA application.
...
> **Tip**: You can modify the file [values.yaml](https://github.com/helmhub-io/charts/tree/main/helmhubio/ejbca/values.yaml)
...
The [HelmHubIO EJBCA](https://github.com/helmhub-io/containers/tree/main/helmhubio/discourse) image stores the EJBCA data and configurations at the `/bitnami` path of the container.
...
The above parameters map to the env variables defined in [helmhubio/ejbca](https://github.com/helmhub-io/containers/tree/main/helmhubio/ejbca). For more information please refer to the [helmhubio/ejbca](https://github.com/helmhub-io/containers/tree/main/helmhubio/ejbca) image documentation.
...
> Note: You need to substitute the placeholders `REGISTRY_NAME` and `REPOSITORY_NAME` with a reference to your Helm chart registry and repository. For example, in the case of HelmHubIO, you need to use `REGISTRY_NAME=registry-1.docker.io` and `REPOSITORY_NAME=helmhubiocharts`.
> **Tip**: You can use the default [values.yaml](https://github.com/helmhub-io/charts/tree/main/helmhubio/ejbca/values.yaml)
