...
This chart bootstraps a [Solr](https://github.com/helmhubio/containers/tree/main/helmhubio/solr) deployment on a [Kubernetes](https://kubernetes.io) cluster using the [Helm](https://helm.sh) package manager.
...
The [HelmHubIO Solr](https://github.com/helmhubio/containers/tree/main/helmhubio/solr) image can persist data. If enabled, the persisted path is `/helmhubio/solr` by default.
