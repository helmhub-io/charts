...
This chart bootstraps a [flink](https://github.com/helmhubio/containers/tree/main/helmhubio/flink) deployment on a [Kubernetes](https://kubernetes.io) cluster using the [Helm](https://helm.sh) package manager.
...
The [HelmHubIO Flink](https://github.com/helmhubio/containers/tree/main/helmhubio/flink) image stores the trace onto an external database. Persistent Volume Claims are used to keep the data across deployments.
