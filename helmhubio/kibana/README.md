...
This chart bootstraps a [Kibana](https://github.com/helmhubio/containers/tree/main/helmhubio/kibana) deployment on a [Kubernetes](https://kubernetes.io) cluster using the [Helm](https://helm.sh) package manager.
...
The [HelmHubIO Kibana](https://github.com/helmhubio/containers/tree/main/helmhubio/kibana) image can persist data. If enabled, the persisted path is `/helmhubio/kibana` by default.
