...
This chart bootstraps a [Nessie](https://github.com/helmhubio/containers/tree/main/helmhubio/nessie) deployment on a [Kubernetes](https://kubernetes.io) cluster using the [Helm](https://helm.sh) package manager.
