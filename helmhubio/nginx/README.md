...
This chart bootstraps a [NGINX Open Source](https://github.com/helmhubio/containers/tree/main/helmhubio/nginx) deployment on a [Kubernetes](https://kubernetes.io) cluster using the [Helm](https://helm.sh) package manager.
