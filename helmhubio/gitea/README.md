...
This chart bootstraps a [Gitea](https://github.com/helmhubio/containers/tree/main/helmhubio/gitea) deployment on a [Kubernetes](https://kubernetes.io) cluster using the [Helm](https://helm.sh) package manager.
...
The [HelmHubIO Gitea](https://github.com/helmhubio/containers/tree/main/helmhubio/gitea) image stores the Gitea data and configurations at the `/helmhubio/gitea` path of the container.
