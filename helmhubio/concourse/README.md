...
The [HelmHubIO Concourse](https://github.com/helmhubio/containers/tree/main/helmhubio/concourse) image stores the concourse data and configurations at the `/bitnami` path of the container. Persistent Volume Claims are used to keep the data across deployments.
...
The above parameters map to the env variables defined in [helmhubio/concourse](https://github.com/helmhubio/containers/tree/main/helmhubio/concourse). For more information please refer to the [helmhubio/concourse](https://github.com/helmhubio/containers/tree/main/helmhubio/concourse) image documentation.
