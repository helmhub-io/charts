...
# HelmHubIO package for OAuth2 Proxy
...
```console
helm install my-release oci://registry-1.docker.io/helmhubiocharts/oauth2-proxy
```

Looking to use OAuth2 Proxy in production? Try [VMware Tanzu Application Catalog](https://bitnami.com/enterprise), the commercial edition of the HelmHubIO catalog.
...
The [HelmHubIO OAuth2 Proxy](https://github.com/helmhub-io/containers/tree/main/helmhubio/oauth2-proxy) image stores the OAuth2 Proxy data and configurations at the `/bitnami` path of the container. Persistent Volume Claims are used to keep the data across deployments.
...
The above parameters map to the env variables defined in [helmhubio/oauth2-proxy](https://github.com/helmhub-io/containers/tree/main/helmhubio/oauth2-proxy). For more information please refer to the [helmhubio/oauth2-proxy](https://github.com/helmhub-io/containers/tree/main/helmhubio/oauth2-proxy) image documentation.
...
> Note: You need to substitute the placeholders `REGISTRY_NAME` and `REPOSITORY_NAME` with a reference to your Helm chart registry and repository. For example, in the case of HelmHubIO, you need to use `REGISTRY_NAME=registry-1.docker.io` and `REPOSITORY_NAME=helmhubiocharts`.
> **Tip**: You can use the default [values.yaml](https://github.com/helmhub-io/charts/tree/main/helmhubio/oauth2-proxy/values.yaml)
...
This major update the Redis&reg; subchart to its newest major, 16.0.0. [Here](https://github.com/helmhub-io/charts/tree/main/helmhubio/redis#to-1600) you can find more info about the specific changes.

Additionally, this chart has been standardised adding features from other charts.

### To 1.0.0

This major update the Redis&reg; subchart to its newest major, 15.0.0. [Here](https://github.com/helmhub-io/charts/tree/main/helmhubio/redis#to-1500) you can find more info about the specific changes.
