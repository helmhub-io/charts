...
The [HelmHubIO OAuth2 Proxy](https://github.com/helmhubio/containers/tree/main/helmhubio/oauth2-proxy) image stores the OAuth2 Proxy data and configurations at the `/bitnami` path of the container. Persistent Volume Claims are used to keep the data across deployments.
...
The above parameters map to the env variables defined in [helmhubio/oauth2-proxy](https://github.com/helmhubio/containers/tree/main/helmhubio/oauth2-proxy). For more information please refer to the [helmhubio/oauth2-proxy](https://github.com/helmhubio/containers/tree/main/helmhubio/oauth2-proxy) image documentation.
