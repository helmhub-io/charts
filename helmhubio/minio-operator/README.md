...
This chart bootstraps a [HelmHubIO Object Storage based on MinIO&reg; Operator](https://github.com/helmhubio/containers/tree/main/helmhubio/minio-operator) deployment on a [Kubernetes](https://kubernetes.io) cluster using the [Helm](https://helm.sh) package manager.
...
The above parameters map to the env variables defined in [helmhubio/minio-operator](https://github.com/helmhubio/containers/tree/main/helmhubio/minio-operator). For more information please refer to the [helmhubio/minio-operator](https://github.com/helmhubio/containers/tree/main/helmhubio/minio-operator) image documentation.
