<!--- app-name: HelmHubIO Object Storage based on MinIO&reg; Operator -->

# HelmHubIO Object Storage based on MinIO&reg; Operator
...
[Overview of HelmHubIO Object Storage based on MinIO&reg; Operator](https://min.io/)
...
```console
helm install my-release oci://registry-1.docker.io/helmhubiocharts/minio-operator
```

Looking to use HelmHubIO Object Storage based on MinIO&reg; Operator in production? Try [VMware Tanzu Application Catalog](https://bitnami.com/enterprise), the commercial edition of the HelmHubIO catalog.
...
This chart bootstraps a [HelmHubIO Object Storage based on MinIO&reg; Operator](https://github.com/helmhub-io/containers/tree/main/helmhubio/minio-operator) deployment on a [Kubernetes](https://kubernetes.io) cluster using the [Helm](https://helm.sh) package manager.
...
The command deploys HelmHubIO Object Storage based on MinIO&reg; Operator on the Kubernetes cluster in the default configuration. The [Parameters](#parameters) section lists the parameters that can be configured during installation.
...
Check the [HelmHubIO Object Storage based on MinIO&reg; Operator official documentation](https://min.io/docs/minio/kubernetes/upstream/operations/deploy-manage-tenants.html) for the list of available objects.
...
The above parameters map to the env variables defined in [helmhubio/minio-operator](https://github.com/helmhub-io/containers/tree/main/helmhubio/minio-operator). For more information please refer to the [helmhubio/minio-operator](https://github.com/helmhub-io/containers/tree/main/helmhubio/minio-operator) image documentation.
...
> Note: You need to substitute the placeholders `REGISTRY_NAME` and `REPOSITORY_NAME` with a reference to your Helm chart registry and repository. For example, in the case of HelmHubIO, you need to use `REGISTRY_NAME=registry-1.docker.io` and `REPOSITORY_NAME=helmhubiocharts`.
> **Tip**: You can use the default [values.yaml](https://github.com/helmhub-io/charts/tree/main/helmhubio/minio-operator/values.yaml)
