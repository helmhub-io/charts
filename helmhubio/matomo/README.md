...
This chart bootstraps a [Matomo](https://github.com/helmhubio/containers/tree/main/helmhubio/matomo) deployment on a [Kubernetes](https://kubernetes.io) cluster using the [Helm](https://helm.sh) package manager.
...
The [HelmHubIO Matomo](https://github.com/helmhubio/containers/tree/main/helmhubio/matomo) image stores the Matomo data and configurations at the `/helmhubio/matomo` path of the container.
