...
This chart bootstraps an [ASP.NET Core](https://github.com/helmhubio/containers/tree/main/helmhubio/aspnet-core) deployment on a [Kubernetes](https://kubernetes.io) cluster using the [Helm](https://helm.sh) package manager.
...
- `clone-repository`: uses the [HelmHubIO GIT Image](https://github.com/helmhubio/containers/tree/main/helmhubio/git) to download the repository.
- `dotnet-publish`: uses the [HelmHubIO .Net SDK Image](https://github.com/helmhubio/containers/tree/main/helmhubio/dotnet-sdk) to build/publish the ASP.NET Core application.
