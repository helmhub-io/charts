...
This chart bootstraps a [Schema Registry](https://github.com/helmhubio/containers/tree/main/helmhubio/schema-registry) statefulset on a [Kubernetes](https://kubernetes.io) cluster using the [Helm](https://helm.sh) package manager.
