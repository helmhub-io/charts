...
# HelmHubIO package for Argo Workflows
...
```console
helm install my-release oci://registry-1.docker.io/helmhubiocharts/argo-workflows
```

Looking to use Argo Workflows in production? Try [VMware Tanzu Application Catalog](https://bitnami.com/enterprise), the commercial edition of the HelmHubIO catalog.
...
> Note: You need to substitute the placeholders `REGISTRY_NAME` and `REPOSITORY_NAME` with a reference to your Helm chart registry and repository. For example, in the case of HelmHubIO, you need to use `REGISTRY_NAME=registry-1.docker.io` and `REPOSITORY_NAME=helmhubiocharts`.
> **Tip**: You can use the default [values.yaml](https://github.com/helmhub-io/charts/tree/main/helmhubio/argo-workflows/values.yaml)
...
This major updates the MySQL subchart to its newest major, 14.0.0. For more information on this subchart's major, please refer to [MySQL upgrade notes](https://github.com/helmhub-io/charts/blob/main/helmhubio/mysql/README.md#user-content-to-1400).

### To 12.0.0

This major updates the MySQL subchart to its newest major, 13.0.0. For more information on this subchart's major, please refer to [MySQL upgrade notes](https://github.com/helmhub-io/charts/blob/main/helmhubio/mysql/README.md#user-content-to-1300).
...
This major updates the MySQL subchart to its newest major, 11.0.0. For more information on this subchart's major, please refer to [MySQL upgrade notes](https://github.com/helmhub-io/charts/blob/main/helmhubio/mysql/README.md#user-content-to-1100).
...
This major release updates the MySQL subchart to its newest major *9.x.x*, which contain several changes in the supported values (check the [upgrade notes](https://github.com/helmhub-io/charts/tree/main/helmhubio/mysql#to-900) to obtain more information).

### To 1.0.0

This major release updates the PostgreSQL subchart to its newest major *11.x.x*, which contain several changes in the supported values (check the [upgrade notes](https://github.com/helmhub-io/charts/tree/main/helmhubio/postgresql#to-1100) to obtain more information).
...
```console
        ...
        helm upgrade argo-workflows helmhubio/argo-workflows \
