...
This chart bootstraps a [Kafka](https://github.com/helmhubio/containers/tree/main/helmhubio/kafka) deployment on a [Kubernetes](https://kubernetes.io) cluster using the [Helm](https://helm.sh) package manager.
...
The [HelmHubIO Kafka](https://github.com/helmhubio/containers/tree/main/helmhubio/kafka) image stores the Kafka data at the `/helmhubio/kafka` path of the container. Persistent Volume Claims are used to keep the data across deployments. This is known to work in GCE, AWS, and minikube.
