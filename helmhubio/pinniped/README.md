...
The [HelmHubIO pinniped](https://github.com/helmhubio/containers/tree/main/helmhubio/pinniped) image stores the pinniped data and configurations at the `/bitnami` path of the container. Persistent Volume Claims are used to keep the data across deployments. This is known to work in GCE, AWS, and minikube.
...
The above parameters map to the env variables defined in [helmhubio/pinniped](https://github.com/helmhubio/containers/tree/main/helmhubio/pinniped). For more information please refer to the [helmhubio/pinniped](https://github.com/helmhubio/containers/tree/main/helmhubio/pinniped) image documentation.
