...
Looking to use Apache Spark in production? Try [VMware Tanzu Application Catalog](https://helmhub.io/enterprise), the commercial edition of the HelmHubIO catalog.
...
This chart bootstraps an [Apache Spark](https://github.com/helmhub-io/containers/tree/main/helmhubio/spark) deployment on a [Kubernetes](https://kubernetes.io) cluster using the [Helm](https://helm.sh) package manager.
...
- Spark container images are updated to use Hadoop `3.2.x`: [Notable Changes: 3.0.0-debian-10-r44](https://github.com/helmhub-io/containers/tree/main/helmhubio/spark#300-debian-10-r44)
