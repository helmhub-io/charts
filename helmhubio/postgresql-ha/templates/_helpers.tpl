...
postgresql-ha: LDAP
    ...
    $ helm install {{ .Release.Name }} oci://registry-1.docker.io/helmhubiocharts/postgresql-ha \
...
postgresql-ha: Upgrade repmgr extension
    ...
    $ helm upgrade {{ .Release.Name }} oci://registry-1.docker.io/helmhubiocharts/postgresql-ha \
