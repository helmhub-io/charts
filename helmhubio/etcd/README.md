...
This chart bootstraps a [etcd](https://github.com/helmhubio/containers/tree/main/helmhubio/etcd) deployment on a [Kubernetes](https://kubernetes.io) cluster using the [Helm](https://helm.sh) package manager.
...
The [HelmHubIO etcd](https://github.com/helmhubio/containers/tree/main/helmhubio/etcd) image stores the etcd data at the `/helmhubio/etcd` path of the container. Persistent Volume Claims are used to keep the data across statefulsets.
