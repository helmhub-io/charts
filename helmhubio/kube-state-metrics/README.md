...
This chart bootstraps [kube-state-metrics](https://github.com/helmhubio/containers/tree/main/helmhubio/kube-state-metrics) on [Kubernetes](https://kubernetes.io) using the [Helm](https://helm.sh) package manager.
