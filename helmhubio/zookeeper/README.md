...
This chart bootstraps a [ZooKeeper](https://github.com/helmhubio/containers/tree/main/helmhubio/zookeeper) deployment on a [Kubernetes](https://kubernetes.io) cluster using the [Helm](https://helm.sh) package manager.
...
The [HelmHubIO ZooKeeper](https://github.com/helmhubio/containers/tree/main/helmhubio/zookeeper) image stores the ZooKeeper data and configurations at the `/helmhubio/zookeeper` path of the container.
