...
This chart bootstraps a [Metrics Server](https://github.com/helmhubio/containers/tree/main/helmhubio/metrics-server) deployment on a [Kubernetes](https://kubernetes.io) cluster using the [Helm](https://helm.sh) package manager.
