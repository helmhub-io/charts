...
This chart bootstraps a [ExternalDNS](https://github.com/helmhubio/containers/tree/main/helmhubio/external-dns) deployment on a [Kubernetes](https://kubernetes.io) cluster using the [Helm](https://helm.sh) package manager.
