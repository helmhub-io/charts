...
# HelmHubIO package for Fluent Bit
...
```console
helm install my-release oci://registry-1.docker.io/helmhubiocharts/fluent-bit
```

Looking to use Fluent Bit in production? Try [VMware Tanzu Application Catalog](https://bitnami.com/enterprise), the commercial edition of the HelmHubIO catalog.
...
This chart bootstraps a [fluent-bit](https://github.com/helmhub-io/containers/tree/main/helmhubio/fluent-bit) deployment on a [Kubernetes](https://kubernetes.io) cluster using the [Helm](https://helm.sh) package manager.
