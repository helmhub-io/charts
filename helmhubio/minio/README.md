<!--- app-name: HelmHubIO Object Storage based on MinIO&reg; -->
...
Looking to use HelmHubIO Object Storage based on MinIOreg; in production? Try [VMware Tanzu Application Catalog](https://bitnami.com/enterprise), the commercial edition of the HelmHubIO catalog.
