...
This chart bootstraps a [Odoo](https://github.com/helmhubio/containers/tree/main/helmhubio/odoo) deployment on a [Kubernetes](https://kubernetes.io) cluster using the [Helm](https://helm.sh) package manager.
...
The [HelmHubIO Odoo](https://github.com/helmhubio/containers/tree/main/helmhubio/odoo) image stores the Odoo data and configurations at the `/helmhubio/odoo` path of the container.
...
The above parameters map to the env variables defined in [helmhubio/odoo](https://github.com/helmhubio/containers/tree/main/helmhubio/odoo). For more information please refer to the [helmhubio/odoo](https://github.com/helmhubio/containers/tree/main/helmhubio/odoo) image documentation.
...
The [HelmHubIO Odoo](https://github.com/helmhubio/containers/tree/main/helmhubio/odoo) image was refactored and now the source code is published in GitHub in the `rootfs` folder of the container image repository.
