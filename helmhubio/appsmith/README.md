...
The [HelmHubIO appsmith](https://github.com/helmhubio/containers/tree/main/helmhubio/appsmith) image stores the appsmith data and configurations at the `/bitnami` path of the container. Persistent Volume Claims are used to keep the data across deployments. This is known to work in GCE, AWS, and minikube.
...
The above parameters map to the env variables defined in [helmhubio/appsmith](https://github.com/helmhubio/containers/tree/main/helmhubio/appsmith). For more information please refer to the [helmhubio/appsmith](https://github.com/helmhubio/containers/tree/main/helmhubio/appsmith) image documentation.
